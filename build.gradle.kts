...
dependencies {
    implementation("com.github.oshi:oshi-core:6.6.5") { // https://github.com/oshi/oshi
...
tasks {
    ...
    runIde {
        ...
        if (pluginEnableDebugLogs.toBoolean()) {
            systemProperties(
                "idea.log.debug.categories" to "#lermitage.intellij.battery.status"
            )
        }
